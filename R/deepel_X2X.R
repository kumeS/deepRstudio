...
#'
#' This function takes text from the clipboard and translates it into the specified target language using the DeepL API.
#' The translated text is then placed back into the clipboard, ready to be pasted wherever needed.
#'
#' @title Translate X Language to Other X Language via DeepL API
...
deepel_X2X <- function(target_lang = 'JA',
